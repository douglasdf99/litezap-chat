    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#2847E9" },
                textPrimary: mode === "light" ? "#2847E9" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#2847E9" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#2847E9" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #2847E9, #0000FF, #00008B)" : "#666",
